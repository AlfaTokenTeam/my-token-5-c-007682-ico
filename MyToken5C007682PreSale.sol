...
import "./MyToken5C007682.sol";

contract MyToken5C007682PreSale {
    MyToken5C007682 public token;
    ...
    function MyToken5C007682PreSale(
        MyToken5C007682 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken5C007682(_token);
